...
func (x *GetUserProfileResponse) GetResponse() *Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *GetUserProfileResponse) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_pkg_pb_user_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x69, 0x6c, 0x22, 0xad, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x32, 0xd8, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x45, 0x0a, 0x0f, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72,
	0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1a, 0x2e, 0x70, 0x62, 0x2e, 0x46, 0x69, 0x6e,
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x08, 0x53,
	0x61, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x61, 0x76,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x70,
	0x62, 0x2e, 0x53, 0x61, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_pkg_pb_user_proto_depIdxs = []int32{
	6, // 0: pb.SaveUserResponse.response:type_name -> pb.Response
	6, // 1: pb.FindUserResponse.response:type_name -> pb.Response
	6, // 2: pb.GetUserProfileResponse.response:type_name -> pb.Response
	2, // 3: pb.UserService.FindUserByEmail:input_type -> pb.FindUserByEmailRequest
	0, // 4: pb.UserService.SaveUser:input_type -> pb.SaveUserRequest
	4, // 5: pb.UserService.GetUserProfile:input_type -> pb.GetUserProfileRequest
	3, // 6: pb.UserService.FindUserByEmail:output_type -> pb.FindUserResponse
	1, // 7: pb.UserService.SaveUser:output_type -> pb.SaveUserResponse
	5, // 8: pb.UserService.GetUserProfile:output_type -> pb.GetUserProfileResponse
